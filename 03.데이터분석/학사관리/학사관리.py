...
def stu_list():
    ...
    for idx, row in merge.iterrows():
        print(idx+1, row['학생번호'], row['학생이름'], row['학생학과'], row['교수이름'], row['생년월일'], row['학년'])
...
def cou_list():
    ...
    for idx, row in merge.iterrows():
        print(row['강좌번호'], row['강좌이름'], row['강의시수'], row['강의실'], row['최대인원'], row['교수이름'], row['교수학과'])
...
def cou_search(code):
    ...
    pro_row = pro.loc[advisor]
    print(cou_row['강좌이름'], cou_row['강의시수'], pro_row['교수이름'])
    print('\n수강학생')
    print('-------------------------------')
